...
<head>
<meta charset="UTF-8">
<title>Parcels - Staff Parcel List</title>
...
%>
	...
	<div class="center-nav">
		<div class="nav-option">
			<a href="staffAddParcel.jsp?email=${email}" class="option-btn-2">Add Parcel</a>  
			<a href="staffParcelList.jsp?email=${email}" class="option-btn-1">Parcel List</a>  
			<a href="staffSearchParcel.jsp?email=${email}" class="option-btn-2">Search Parcel</a>
